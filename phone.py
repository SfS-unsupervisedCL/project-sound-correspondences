class Phone(object):
	...
	def __init__(self, sound_type, manner, place, voice, secondary, vertical, horizontal, rounding, length, nasalization):
	...
	def distance(self, other):
		...
		# TODO different weights? e.g. for sound_type or regarding scalar values (like vowel positions)
